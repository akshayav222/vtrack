                                                     ...
                                                     <div class="card-block">
                                                        <form method="post" action="action/workshop_update.php" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="wtype" class="form-control form-control-primary" value="<?php echo $wtype;?>" required>
                                                                </div>
                                                            </div>
                                                             <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                     <textarea name="srvce" rows="5" cols="5" class="form-control form-control-primary" required><?php echo $srvce;?></textarea>
                                                                </div>
                                                            </div>                                                                                                                        
