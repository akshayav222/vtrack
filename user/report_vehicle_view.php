<?php
	...
	$resultv->execute();
	for($iv=1; $rowv = $resultv->fetch(); $iv++)
	{
		$vamt=$rowv["amt"];
	}
?>	
                                						...
                                						<div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <?php
																			$total=0;
																	$result = $db->prepare("select * from track where date >= '$fdate' AND date <= '$tdate' AND vhno='$vno' order by date asc");
																			$result->execute();
																		...
																		?>
																			 ...
																			 <tr>              
																				 <td colspan="1"><b>Vehicle Amount</b></td>
                                                                                 <td colspan="1" style="color:red;">
																				 <b><?php echo $vamt?></b><br><br>                  
																				 </td>
																				 <td colspan="1"><b>Expense</b></td>
																				 <td colspan="1" style="color:red;">
