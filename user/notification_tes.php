                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">         
                                                	<div class="card-header">
                                                        <h5 class="m-b-10">Test Notification</h5>
                                                     ...
                                                     <div class="card-block table-border-style">
                                						<div class="table-responsive">
                                                            <table class="table">
                                                                <thead>
                                                                   <tr>
                                                                        <th>Sl No</th>                                                                        <th>Name</th>                                                                        <th>Type</th>                                 
                                                                        <th>Company</th>  
                                                                        <th>Description</th>
                                                                        <th>Amount</th>
                                                                        <th>Date</th>
                                                                ...
                                                                <tbody>
                                                                    <?php
																	$result = $db->prepare("select * from taxtest where txtst='Test'");
																			$result->execute();
																			for($i=1; $row = $result->fetch(); $i++)
																			{
																				echo"<tr>";
																					...
																					echo"<td>".$row["amt"]."</td>";
																					echo"<td>".$row["date"]."</td>";
													echo"<td><span class='label label-danger'>".$row["ndate"]."</span></td>";
																				echo"</tr>";
																			}
																		?>
																		</tr>              
