                                                     ...
                                                     <div class="card-block">
                                                        <form method="post" action="action/product_update.php" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="number" name="qty" class="form-control form-control-primary" value="<?php echo $qty;?>" required min="0" step="0.01">
                                                                </div>
                                                            </div>                                                  
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Price</label>
                                                                <div class="col-sm-10">
                                                                    <input type="number" name="price" class="form-control form-control-primary" value="<?php echo $price;?>" required min="0" step="0.01">
                                                                </div>
                                                            </div>
                                                             <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Tax</label>
                                                                <div class="col-sm-10">
                                                                    <input type="number" name="tax" class="form-control form-control-primary" value="<?php echo $tax;?>" required min="0" step="0.01">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                     <textarea name="desp" rows="5" cols="5" class="form-control form-control-primary" required><?php echo $desp;?></textarea>
                                                                </div>
                                                            </div>                                                                                                                        
